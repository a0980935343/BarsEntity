...
namespace Barsix.BarsEntity
{
    static class GuidList
    {
        ...
        public const string guidAddQuartzTaskCmdSetString = "32af8a17-bbbc-4c56-877e-fc6c6575a8cd";
        ...
        public static readonly Guid guidAddQuartzTaskCmdSet = new Guid(guidAddQuartzTaskCmdSetString);
    }
    ...
    static class PkgCmdIDList
    {
        ...
        public const uint cmdidAddQuartzTask = 0x105;
    }
}