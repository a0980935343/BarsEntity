...
namespace Barsix.BarsEntity.BarsGenerators
{
    ...
    public class ViewGenerator : BaseBarsGenerator
    {
        ...
        private void EASViewType(EntityOptions options, GeneratedFragments fragments, GeneratedFile file, ControllerOptions controllerOpts)
        {
            ...
            resources.Lines.Add("container.Add(\"scripts/modules/{3}.js\", \"{0}.dll/{0}.Views.{2}{1}.js\");".R(_project.DefaultNamespace, options.ClassName, options.IsDictionary ? "Dict." : "", options.View.Namespace));
        ...
        private void ViewModelViewType(EntityOptions options, GeneratedFragments fragments, GeneratedFile file, ControllerOptions controllerOpts)
        {
            ...
            resources.Lines.Add("container.Add(\"scripts/modules/{0}.{1}.js\", new GridPageView<{1}ViewModel>());".R(_project.DefaultNamespace, options.ClassName, options.IsDictionary ? "Dict." : ""));
